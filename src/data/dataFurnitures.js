const furnitureList = [
  {
    path: "assets/furnitures/Adrien_Messie-Fibonacci_Stool.jpg",
  ...
  {
    path: "assets/furnitures/Adrien_Messie-Fibonacci_Table.jpg",
  ...
  {
    path: "assets/furnitures/Emmanuelle_Simon-Jellyfish_Lamps.jpg",
  ...
  {
    path: "assets/furnitures/Emmanuelle_Simon-Jellyfish_Mirror.jpg",
  ...
  {
    path: "assets/furnitures/Exercice-Chair.jpg",
    name: "Chair - Exercice",
  ...
  {
    path: "assets/furnitures/Francesco_Balzano-Constantin_Bench_Resin.jpg",
  ...
  {
    path: "assets/furnitures/Francesco_Balzano-Constantin_Bench_Travertine.jpg",
  ...
  {
    path: "assets/furnitures/Garnier_&_Linker-Crystal_Centrepiece.jpg",
  ...
  {
    path: "assets/furnitures/Garnier_&_Linker-Plaster_Centrepiece.jpg",
  ...
  {
    path: "assets/furnitures/Hall.haus-Udo_Udo_Coffee_Table.jpg",
  ...
  {
    path: "assets/furnitures/Joris_Poggioli-Ellsworth_Mirror.jpg",
  ...
  {
    path: "assets/furnitures/Joris_Poggioli-Totem_Library.jpg",
  ...
  {
    path: "assets/furnitures/Matéo_Garcia-Jimena_Vase.jpg",
  ...
  {
    path: "assets/furnitures/POOL-Achille_Brass_Cube.jpg",
  ...
  {
    path: "assets/furnitures/POOL-Achille_Meridienne.jpg",
  ...
  {
    path: "assets/furnitures/POOL-Achille.jpg",
    name: "Achille Chair - POOL",
    desc: " The Achille Chair is a sculpted foam curved form that is upholstered with a wool and alpaca bouclé fabric. Its comfortable curves contrast with the strict copper cube it sits on. The chair is handmade by craftsmen in France. It is a numbered and signed edition.",
    link: " https://www.theoremeeditions.com/shop/studio-pool-armchair"
  },
  {
    path: "assets/furnitures/SCMP_DESIGN_OFFICE-T.jpg",
  ...
  {
    path: "assets/furnitures/SCMP_DESIGN_OFFICE-X.jpg",
  ...
  {
    path: "assets/furnitures/Services_Généraux-Contenu_Vase.jpg",
  ...
  {
    path: "assets/furnitures/Services_Généraux-Maillons_Vase.jpg",
  ...
  {
    path: "assets/furnitures/Services_Généraux-Paysan_Table.jpg",
  ...
  {
    path: "assets/furnitures/Theoreme-editions_Valentin-Fougeray_Autres_49.jpg",
  ...
  {
    path: "assets/furnitures/Victoria-Wilmotte-Pleat-Console.jpg",
